    ...
    if (r) {
      ...
      if (__PRIVATE_targetIsDocumentTarget(i)) if (0 === n) {
        ...
        if (r2 !== n) {
          ...
          wt == null ? void 0 : wt.lt(function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e2, t2, n3, r3, i3) {
            var _a, _b, _c;
            const s = {
              localCacheCount: e2,
...
var __PRIVATE_FirestoreIndexValueWriter = class {
  ...
  kt(e, t) {
    ...
    const n = e.fields || {};
    this.Ft(t, 53);
    const r = Et, i = ((_b = (_a = n[r].arrayValue) == null ? void 0 : _a.values) == null ? void 0 : _b.length) || 0;
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  zi() {
    var _a;
    "function" == typeof ((_a = this.window) == null ? void 0 : _a.addEventListener) && (this.Bi = () => {
      this.cs();
  ...
  us(e) {
    var _a;
    try {
      const t = null !== ((_a = this.Ki) == null ? void 0 : _a.getItem(this._s(e)));
...
function aggregateFieldEqual(e, t) {
  var _a, _b;
  return e instanceof AggregateField && t instanceof AggregateField && e.aggregateType === t.aggregateType && ((_a = e._internalFieldPath) == null ? void 0 : _a.canonicalString()) === ((_b = t._internalFieldPath) == null ? void 0 : _b.canonicalString());
}
...
var __PRIVATE_MemoryLocalCacheImpl = class {
  constructor(e) {
    this.kind = "memory", this._onlineComponentProvider = OnlineComponentProvider.provider, this._offlineComponentProvider = (e == null ? void 0 : e.garbageCollector) ? e.garbageCollector._offlineComponentProvider : {
...
var __PRIVATE_PersistentLocalCacheImpl = class {
  constructor(e) {
    let t;
    this.kind = "persistent", (e == null ? void 0 : e.tabManager) ? (e.tabManager._initialize(e), t = e.tabManager) : (t = persistentSingleTabManager(void 0), t._initialize(e)), this._onlineComponentProvider = t._onlineComponentProvider, this._offlineComponentProvider = t._offlineComponentProvider;
  }
  toJSON() {
    return {
      kind: this.kind
...
function memoryLruGarbageCollector(e) {
  return new __PRIVATE_MemoryLruGarbageCollectorImpl(e == null ? void 0 : e.cacheSizeBytes);
}
...
var __PRIVATE_SingleTabManagerImpl = class {
  ...
  _initialize(e) {
    this._onlineComponentProvider = OnlineComponentProvider.provider, this._offlineComponentProvider = {
      build: (t) => new __PRIVATE_IndexedDbOfflineComponentProvider(t, e == null ? void 0 : e.cacheSizeBytes, this.forceOwnership)
    };
  }
};
var __PRIVATE_MultiTabManagerImpl = class {
  ...
  _initialize(e) {
    this._onlineComponentProvider = OnlineComponentProvider.provider, this._offlineComponentProvider = {
      build: (t) => new __PRIVATE_MultiTabOfflineComponentProvider(t, e == null ? void 0 : e.cacheSizeBytes)
    };
  }
};
function persistentSingleTabManager(e) {
  return new __PRIVATE_SingleTabManagerImpl(e == null ? void 0 : e.forceOwnership);
}
  ...
  const r = function __PRIVATE_parseIndexes(e2) {
    const t2 = "string" == typeof e2 ? function __PRIVATE_tryParseJson(e3) {
      try {
        ...
        throw new FirestoreError(N.INVALID_ARGUMENT, "Failed to parse JSON: " + (e4 == null ? void 0 : e4.message));
      }
    }(e2) : e2, n2 = [];
